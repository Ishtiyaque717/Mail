...
//hi
    ...
    String sendMail(@RequestBody String maildIds) throws Exception {
        String body="<!-- HTML Codes by Quackit.com -->\n" +
                ...
                "        <p></p>\n" +
                "        <p>• Total Experience- <strong>3.9 years</strong></p>\n" +
        ...
        for(String id : to) {
            ...
            mailService.sendMail("ishtiyaque717@gmail.com",
                    id,
                    "JAVA Developer 3.9 years of Experience || Immediate Joiner",
                    body);
            System.out.println("sent mail to id "+ id);
        }
        return "success";
    }
}
